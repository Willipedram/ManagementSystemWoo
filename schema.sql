...
CREATE TABLE IF NOT EXISTS msw_user_kpi_events (
  ...
  FOREIGN KEY (history_id) REFERENCES msw_product_content_history(id) ON DELETE CASCADE,
  FOREIGN KEY (user_id) REFERENCES msw_users(id) ON DELETE CASCADE,
  FOREIGN KEY (assigned_user_id) REFERENCES msw_users(id) ON DELETE SET NULL,
