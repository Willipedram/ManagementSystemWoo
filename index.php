...
initProducts(); initUsers(); initAssignments(); initLogs(); initSearchConsole(); initUserLog();
$('button[data-bs-toggle="tab"]').on('shown.bs.tab',function(e){const t=$(e.target).data('bs-target');if(t==='#products') loadProducts(); if(t==='#users') loadUsers(); if(t==='#assignments') loadAssignUsers(); if(t==='#logs') loadLogs(); if(t==='#searchConsole') loadSearchConsole();});
