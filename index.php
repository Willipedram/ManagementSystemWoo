...
<div class="tab-pane fade p-3" id="analytics">
  ...
  <div class="tab-pane fade p-3" id="logs">
    <table class="table table-striped text-end" id="logTable" style="direction:ltr;">
 ...
 if(!usersTable){
  usersTable=$('#usersTable').DataTable({
   ...
   columns:[
    ...
    {data:'status'},
    {data:'created_at'},
    {data:null,render:d=>`<button class="btn btn-sm btn-primary edit-user" data-id="${d.id}">ویرایش</button> <button class="btn btn-sm btn-danger delete-user" data-id="${d.id}">حذف</button>`}
   ]
  });
