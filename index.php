  ...
  <div class="tab-pane fade p-3" id="searchConsole">
    ...
    <div class="tab-content">
      <div class="tab-pane fade show active" id="scKeywords">
        ...
        <canvas id="scChart" height="150" class="mb-3"></canvas>
...
<div class="modal fade" id="internalLinksModal" tabindex="-1">
 <div class="modal-dialog modal-lg">
  <div class="modal-content">
   <div class="modal-header"><h5 class="modal-title">لینک‌های داخلی</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
   <div class="modal-body">
    <table id="internalLinksTable" class="table table-striped w-100"><thead><tr><th>دسته</th><th>آدرس</th><th>عنوان</th><th>عملیات</th></tr></thead><tbody></tbody></table>
    <input type="hidden" id="il_id">
    <div class="row g-2 mt-3">
      <div class="col-md-4"><input type="text" id="il_category" class="form-control" placeholder="دسته"></div>
      <div class="col-md-4"><input type="text" id="il_url" class="form-control" placeholder="آدرس"></div>
      <div class="col-md-4"><input type="text" id="il_title" class="form-control" placeholder="عنوان"></div>
    </div>
  ...
  productsTable=$('#productsTable').DataTable({
    columns:[
      ...
      {data:'score', render:data=>{
         ...
         return `<span class='badge ${cls} w-100'>${txt}</span>`;
      }},
