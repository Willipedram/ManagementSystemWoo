...
// DataTables tables
let productsTable, usersTable, logsTable, userLogDataTable, assignUsersTable, assignedProductsTable, searchConsoleTable, sessionsTable, userSessionDataTable, rolesTable, processesTable;
...
function initProducts(){
  productsTable=$('#productsTable').DataTable({
    columns:[
      ...
      {data:'score', render:data=>data!==null?data:'-'},
