...
case 'fetch_search_console':
  // نمونه دادهٔ تستی برای نمایش
  $data = array(
    array('query'=>'نمونه', 'clicks'=>50, 'impressions'=>1000, 'ctr'=>'5%', 'position'=>7.2),
    array('query'=>'تست', 'clicks'=>20, 'impressions'=>500, 'ctr'=>'4%', 'position'=>9.1)
  );
...
case 'load_api_settings':
  ...
  $db->close();
  echo json_encode(array('success'=>true,'ipify'=>$ipify,'sc_client_id'=>$cid,'sc_client_secret'=>$secret));
  break;
