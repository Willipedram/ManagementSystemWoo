...
case 'list_prices':
  ...
  if($res){
    ...
    echo json_encode(['success'=>false,'message'=>'خطای دیتابیس','steps'=>$steps]);
    $db->close();
    break;
  }
  $db->close();
  echo json_encode(['success'=>true,'data'=>$rows,'steps'=>$steps]);
  break;
